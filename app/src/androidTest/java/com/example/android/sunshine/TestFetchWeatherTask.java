...
import com.example.android.WeatherThisWeek.FetchWeatherTask;
import com.example.android.WeatherThisWeek.data.WeatherContract;

public class TestFetchWeatherTask extends AndroidTestCase{
    static final String ADD_LOCATION_SETTING = "Chandler, AZ";
    static final String ADD_LOCATION_CITY = "Chandler";
